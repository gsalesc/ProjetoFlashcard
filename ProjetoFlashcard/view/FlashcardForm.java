...
public class FlashcardForm extends JFrame {
	...
	private JButton virar, esquerda, direita;
	private JButton excluir, trocar;
	private JPanel frente, verso;
	private LadoCarta lado;
	private List<Flashcard> baralho;
	...
	public FlashcardForm(List<Flashcard> baralho, Flashcard atual, String num, JFrame pai) {
		super(num);
		iniciarComponentes();
		setBaralho(baralho);
		setAtual(atual);
	...
	public FlashcardForm(List<Flashcard> baralho, Flashcard atual, String num, LadoCarta lado, JFrame pai) {
		super(num);
		iniciarComponentes();
		setBaralho(baralho);
		setAtual(atual);
	...
	private void excluirCarta() {
		...
		int op = JOptionPane.showConfirmDialog(null, "Deseja excluir essa carta?");
			if(op == JOptionPane.YES_OPTION) {
			FlashcardController fc = new FlashcardController();
			fc.excluirCartaController(this.getAtual());
