...
public class TabuleiroForm extends JFrame{
	...
	private void carregarFlashcards() {
		...
		BaralhoController cbc = new BaralhoController();
		List<Flashcard> bar = cbc.retornaBaralho().getCartas();
		int qtdCartas = cbc.tamanhoBaralho();
	...
	private void sortearCarta() {
		BaralhoController bc = new BaralhoController();
		Flashcard novo = bc.sortear();
		FlashcardForm flashcard = new FlashcardForm(bc.retornaBaralho().getCartas(),novo, String.valueOf(novo.getCodigo()), this);
