...
public class AdicionarFlashcardForm extends JFrame{
	...
	public AdicionarFlashcardForm(Component comp) {
		super("Adicionar flashcard");
		setSize(500, 400);
		this.setLayout(null);
		iniciarComponentes();
	...
	private void adicionarFlashcard() {
		if(!(txtImagemPergunta.getText().equals("") && txtImagemDescricao.getText().equals(""))) {
			...
			fc.adicionarFlashcard(txtPergunta.getText(), txtImagemPergunta.getText(), txtDescricao.getText(), txtImagemDescricao.getText());
